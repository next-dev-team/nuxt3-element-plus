<template>
  <footer class="bg-white">
    <div class="max-w-screen-xl px-4  pb-6 mx-auto sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 gap-8 pt-16 border-t border-gray-100 md:grid-cols-4 lg:grid-cols-6">
              ...
              <li>
                ...
                >
                  ...
                  <span class="relative flex w-2 h-2 -mr-2">
                    <span class="absolute inline-flex w-full h-full bg-teal-400 rounded-full opacity-75 animate-ping" />
                    <span class="relative inline-flex w-2 h-2 bg-teal-500 rounded-full" />
                  </span>
                </a>
              </li>
            </ul>
